...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "loadstring(game:HttpGet("https://raw.githubusercontent.com/angeltatgod/Key-System/refs/heads/main/Script.lua"))()", -- The raw URL of your main script
